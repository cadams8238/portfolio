...
const emojiContent = {
  ...
  can write less and say more!`,
	links: {
		app: "https://learn-emojis.herokuapp.com/",
		code:
			"https://github.com/thinkful-ei21/courtney-james-spacedRepitition-client"
	},
	stack:
		"React, Redux, CSS Modules, HTML, JavaScript, Node, Express, MongoDB, Mongoose"
};
...
const financeContent = {
  ...
  and get reminder emails when they're due.`,
	links: {
		app: "https://acceptable-losses.herokuapp.com/",
